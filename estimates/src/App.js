...
const Home = () => {
  ...
  <div className="flex space-x-4">
    ...
    <button>Overstanding Estimates</button>
  </div>
...
<div className="flex items-center border py-2 border-black bg-[#FFFFFF] ml-6 mr-6  ">
  ...
  <div className=" w-1/6 px-4 text-center ">EST-1001</div>
  ...
  <div className="w-32 ml-10 px-6 text-center bg-green-500">Accepted</div>
</div>
...
<div className="flex items-center border py-2 border-black bg-[#FFFFFF] ml-6 mr-6  ">
  ...
  <div className="w-1/6 px-4 text-center">16 Aug 2024</div>
  <div className=" w-1/6 px-4 text-center">₹2,50,000</div>
  <div className="w-32 ml-10 px-6 text-center bg-red-500">Rejected</div>
</div>
...
<div className="flex items-center border py-2 border-black bg-[#FFFFFF] ml-6 mr-6  ">
  ...
  <div className="w-1/6 px-4 text-center">16 Aug 2024</div>
  <div className=" w-1/6 px-4 text-center">₹2,50,000</div>
  <div className="w-32 ml-10 px-6 text-center bg-yellow-500">Expired</div>
</div>
...
<div className="flex items-center border py-2 border-black bg-[#FFFFFF] ml-6 mr-6  ">
  ...
  <div className="w-1/6 px-4 text-center">16 Aug 2024</div>
  <div className=" w-1/6 px-4 text-center">₹2,50,000</div>
  <div className="w-32 ml-10 px-6 text-center bg-purple-500">Pending</div>
</div>
...
<div className="flex items-center border py-2 border-black bg-[#FFFFFF] ml-6 mr-6  ">
  <div className=" w-1/5  text-center">Acme Industries</div>
  <div className=" w-1/5  text-center ">EST-1001</div>
  <div className="w-1/5  text-center">12 Aug 2024,11:00 AM</div>
  <div className=" w-1/5  text-center">₹2,50,000</div>
  <div className=" w-1/5 mr-4 text-center">Approved with minor revisions</div>
</div>

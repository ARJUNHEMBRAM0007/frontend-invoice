...
<div className="flex items-center border py-2 border-black bg-[#FFFFFF] ml-6 mr-6 space-x-10 ml-2 mr-2 ">
  <div className="  w-1/7 px-7 text-center">EXP-1001</div>
...
<div className="flex items-center border py-2 border-black bg-[#FFFFFF] ml-6 mr-6  ">
  <div className=" w-1/4  text-center">June 2024</div>

...
<div className="flex  border py-2 border-black bg-[#FFFFFF] ml-6 mr-6 space-x-12     ">
  ...
  <div className=" px-3 text-center ">Homepage Redsesign</div>
  <div className=" px-3 text-center">4 hours</div>
  <div className=" px-3 text-center">Nisha Verma</div>
  <div className=" w-32  text-center bg-green-500">Bialbe</div>
</div>
...
<div className="flex  border py-2 border-black bg-[#FFFFFF] ml-6 mr-6 space-x-12     ">
  ...
  <div className=" px-3 text-center">4 hours</div>
  <div className=" px-3 text-center">Nisha Verma</div>
  <div className=" w-32  text-center bg-yellow-500">Non-Bialbe</div>
</div>
...
<div className="grid grid-cols-3 gap-4 pl-6 pr-6 pt-6">
  ...
  <div className="col-span-2 flex flex-col">
    ...
    <div className="flex  border py-2 border-black mb-4 shadow bg-[#FFFFFF]">
      ...
      <div className="w-1/3 px-4 text-center">Bailaber Hours</div>
      <div className="w-1/3 px-4 text-center">Non-Bailaber Hours</div>
    </div>
